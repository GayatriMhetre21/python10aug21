...
btn_cut  = tk.Button(fr_buttons, text="Cut text", command=cut)
btn_copy = tk.Button(fr_buttons, text="Copy text", command=copy)
btn_paste= tk.Button(fr_buttons, text="Paste text", command=paste)
